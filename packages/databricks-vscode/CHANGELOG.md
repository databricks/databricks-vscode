...
-   Add exception handlers to bootstrap python code (#1258) ([b40f14c](https://github.com/databricks/databricks-vscode/commit/b40f14c)), closes [#1258](https://github.com/databricks/databricks-vscode/issues/1258)
