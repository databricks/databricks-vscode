...
export class DbfsService {
    constructor(readonly client: ApiClient){}
        ...
        private async _addBlock(request:  files.AddBlock,
    ...
    * `MAX_BLOCK_SIZE_EXCEEDED`.
        */
        @withLogContext(ExposedLoggers.SDK)
        async addBlock(request:  files.AddBlock,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _close(request:  files.Close,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * exist, this call throws an exception with `RESOURCE_DOES_NOT_EXIST`.
        */
        @withLogContext(ExposedLoggers.SDK)
        async close(request:  files.Close,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _create(request:  files.Create,
            @context context?: Context
        ): Promise<
    ...
    * the handle you have.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(request:  files.Create,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _delete(request:  files.Delete,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * periodic delete jobs.
        */
        @withLogContext(ExposedLoggers.SDK)
        async delete(request:  files.Delete,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _getStatus(request:  files.GetStatusRequest,
            @context context?: Context
        ): Promise<
    ...
    * `RESOURCE_DOES_NOT_EXIST`.
        */
        @withLogContext(ExposedLoggers.SDK)
        async getStatus(request:  files.GetStatusRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _list(request:  files.ListDbfsRequest,
            @context context?: Context
        ): Promise<
    ...
    * the same functionality without timing out.
        */
        @withLogContext(ExposedLoggers.SDK)
        async *list(request: files.ListDbfsRequest,
            @context context?: Context    
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _mkdirs(request:  files.MkDirs,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * some of the necessary parent directories.
        */
        @withLogContext(ExposedLoggers.SDK)
        async mkdirs(request:  files.MkDirs,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _move(request:  files.Move,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * files.",
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _put(request:  files.Put,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * see :method:dbfs/create, :method:dbfs/addBlock, :method:dbfs/close.
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _read(request:  files.ReadDbfsRequest,
            @context context?: Context
        ): Promise<
    ...
    * contents until the end of file.",
        */
        @withLogContext(ExposedLoggers.SDK)
        async read(request:  files.ReadDbfsRequest,
            @context context?: Context
        ): Promise<
