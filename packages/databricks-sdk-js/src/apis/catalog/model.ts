...
* Function parameter style. **S** is the value for SQL.
*/
export type CreateFunctionParameterStyle = 
"S"
;
...
*/
export type CreateFunctionRoutineBody = 
"EXTERNAL"
 |"SQL"
;
...
* Function security type.
*/
export type CreateFunctionSecurityType = 
"DEFINER"
;
...
* it.
*/
export type EnableAutoMaintenance = 
"DISABLE"
 |"ENABLE"
 |"INHERIT"
;
...
* Function parameter style. **S** is the value for SQL.
*/
export type FunctionInfoParameterStyle = 
"S"
;
...
* not supported), and the __sql_data_access__ field must be **NO_SQL**.
*/
export type FunctionInfoRoutineBody = 
"EXTERNAL"
 |"SQL"
;
...
* Function security type.
*/
export type FunctionInfoSecurityType = 
"DEFINER"
;
...
* The operation tested.
*/
export type ValidationResultOperation = 
"DELETE"
 |"LIST"
 |"READ"
 |"WRITE"
...
* The results of the tested operation.
*/
export type ValidationResultResult = 
"FAIL"
 |"PASS"
 |"SKIP"
;
