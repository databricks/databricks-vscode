...
export class AccountMetastoreAssignmentsService {
    ...
    ): Promise<Array<catalog.CreateMetastoreAssignmentsResponseItem>> {
    ...
    private async _get(
        ...
        @context context?: Context
    ): Promise<catalog.AccountsMetastoreAssignment> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.AccountsMetastoreAssignment;
    }
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<Array<catalog.MetastoreAssignment>> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
...
export class AccountMetastoresService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<catalog.AccountsMetastoreInfo> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.AccountsMetastoreInfo;
    }
    ...
    private async _list(
        @context context?: Context
    ): Promise<catalog.ListMetastoresResponse> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            undefined,
            context
        )) as catalog.ListMetastoresResponse;
    }
...
export class AccountStorageCredentialsService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<catalog.StorageCredentialInfo> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.StorageCredentialInfo;
    }
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<catalog.ListStorageCredentialsResponse> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.ListStorageCredentialsResponse;
    }
...
export class CatalogsService {
    ...
    private async _list(
        @context context?: Context
    ): Promise<catalog.ListCatalogsResponse> {
        const path = "/api/2.1/unity-catalog/catalogs";
        return (await this.client.request(
            path,
            "GET",
            undefined,
            context
        )) as catalog.ListCatalogsResponse;
    }
...
export class ConnectionsService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<catalog.ConnectionInfo> {
    ...
    private async _list(
        @context context?: Context
    ): Promise<catalog.ListConnectionsResponse> {
        const path = "/api/2.1/unity-catalog/connections";
        return (await this.client.request(
            path,
            "GET",
            undefined,
            context
        )) as catalog.ListConnectionsResponse;
    }
...
export class ExternalLocationsService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<catalog.ExternalLocationInfo> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.ExternalLocationInfo;
    }
    ...
    private async _list(
        @context context?: Context
    ): Promise<catalog.ListExternalLocationsResponse> {
        const path = "/api/2.1/unity-catalog/external-locations";
        return (await this.client.request(
            path,
            "GET",
            undefined,
            context
        )) as catalog.ListExternalLocationsResponse;
    }
...
export class FunctionsService {
    ...
    @withLogContext(ExposedLoggers.SDK)
    private async _create(
        request: catalog.CreateFunction,
        @context context?: Context
    ): Promise<catalog.FunctionInfo> {
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<catalog.ListFunctionsResponse> {
        const path = "/api/2.1/unity-catalog/functions";
        return (await this.client.request(
            path,
            "GET",
            request,
            context
        )) as catalog.ListFunctionsResponse;
    }
...
export class GrantsService {
    ...
    private async _getEffective(
        ...
        @context context?: Context
    ): Promise<catalog.EffectivePermissionsList> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.EffectivePermissionsList;
    }
...
export class MetastoresService {
    ...
    private async _current(
        @context context?: Context
    ): Promise<catalog.MetastoreAssignment> {
        ...
        return (await this.client.request(
            ...
            undefined,
            context
        )) as catalog.MetastoreAssignment;
    }
    ...
    private async _maintenance(
        request: catalog.UpdateAutoMaintenance,
        @context context?: Context
    ): Promise<catalog.UpdateAutoMaintenanceResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.UpdateAutoMaintenanceResponse;
    }
    ...
    private async _summary(
        @context context?: Context
    ): Promise<catalog.GetMetastoreSummaryResponse> {
        ...
        return (await this.client.request(
            ...
            undefined,
            context
        )) as catalog.GetMetastoreSummaryResponse;
    }
...
export class SchemasService {
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<catalog.ListSchemasResponse> {
        const path = "/api/2.1/unity-catalog/schemas";
        return (await this.client.request(
            path,
            "GET",
            request,
            context
        )) as catalog.ListSchemasResponse;
    }
...
export class StorageCredentialsService {
    ...
    private async _validate(
        ...
        @context context?: Context
    ): Promise<catalog.ValidateStorageCredentialResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.ValidateStorageCredentialResponse;
    }
...
export class SystemSchemasService {
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<catalog.ListSystemSchemasResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.ListSystemSchemasResponse;
    }
...
export class TableConstraintsService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<catalog.TableConstraint> {
...
export class TablesService {
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<catalog.ListTablesResponse> {
    ...
    private async _listSummaries(
        ...
        @context context?: Context
    ): Promise<catalog.ListTableSummariesResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.ListTableSummariesResponse;
    }
...
export class VolumesService {
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<catalog.ListVolumesResponseContent> {
        const path = "/api/2.1/unity-catalog/volumes";
        return (await this.client.request(
            path,
            "GET",
            request,
            context
        )) as catalog.ListVolumesResponseContent;
    }
...
export class WorkspaceBindingsService {
    ...
    private async _get(
        ...
        @context context?: Context
    ): Promise<catalog.CurrentWorkspaceBindings> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as catalog.CurrentWorkspaceBindings;
    }
