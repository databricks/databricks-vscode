...
export class AccountIpAccessListsService {
    ...
    private async _create(
    ...
    ): Promise<settings.CreateIpAccessListResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as settings.CreateIpAccessListResponse;
    }
    ...
    private async _get(
        ...
        @context context?: Context
    ): Promise<settings.GetIpAccessListResponse> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as settings.GetIpAccessListResponse;
    }
    ...
    private async _list(
        @context context?: Context
    ): Promise<settings.GetIpAccessListsResponse> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            undefined,
            context
        )) as settings.GetIpAccessListsResponse;
    }
...
export class AccountSettingsService {
    ...
    private async _deletePersonalComputeSetting(
        ...
        @context context?: Context
    ): Promise<settings.DeletePersonalComputeSettingResponse> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as settings.DeletePersonalComputeSettingResponse;
    }
    ...
    private async _readPersonalComputeSetting(
        ...
        @context context?: Context
    ): Promise<settings.PersonalComputeSetting> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as settings.PersonalComputeSetting;
    }
...
export class IpAccessListsService {
    ...
    private async _get(
        ...
        @context context?: Context
    ): Promise<settings.FetchIpAccessListResponse> {
        const path = `/api/2.0/ip-access-lists/${request.ip_access_list_id}`;
        return (await this.client.request(
            path,
            "GET",
            request,
            context
        )) as settings.FetchIpAccessListResponse;
    }
...
export class TokenManagementService {
    ...
    private async _createOboToken(
        ...
        @context context?: Context
    ): Promise<settings.CreateOboTokenResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as settings.CreateOboTokenResponse;
    }
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<settings.ListTokensResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as settings.ListTokensResponse;
    }
...
export class TokensService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<settings.CreateTokenResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as settings.CreateTokenResponse;
    }
     ...
     */
    @withLogContext(ExposedLoggers.SDK)
    async *list(@context context?: Context): AsyncIterable<settings.TokenInfo> {
...
export class WorkspaceConfService {
    ...
    private async _getStatus(
        ...
        @context context?: Context
    ): Promise<settings.WorkspaceConf> {
