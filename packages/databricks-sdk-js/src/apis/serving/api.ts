...
export class ServingEndpointsService {
    ...
    ): Promise<serving.BuildLogsResponse> {
    ...
    private async _create(
        request: serving.CreateServingEndpoint,
        @context context?: Context
    ): Promise<serving.ServingEndpointDetailed> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as serving.ServingEndpointDetailed;
    }
    ...
    async create(
        ...
        Waiter<serving.ServingEndpointDetailed, serving.ServingEndpointDetailed>
    > {
    ...
    private async _list(
        @context context?: Context
    ): Promise<serving.ListEndpointsResponse> {
        const path = "/api/2.0/serving-endpoints";
        return (await this.client.request(
            path,
            "GET",
            undefined,
            context
        )) as serving.ListEndpointsResponse;
    }
    ...
    private async _logs(
        ...
        @context context?: Context
    ): Promise<serving.ServerLogsResponse> {
    ...
    private async _query(
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as serving.QueryEndpointResponse;
    }
    ...
    private async _updateConfig(
        request: serving.EndpointCoreConfigInput,
        @context context?: Context
    ): Promise<serving.ServingEndpointDetailed> {
