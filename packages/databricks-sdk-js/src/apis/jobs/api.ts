...
export class JobsService {
    constructor(readonly client: ApiClient){}
        ...
        private async _cancelAllRuns(request:  jobs.CancelAllRuns,
    ...
    * it doesn't prevent new runs from being started.
        */
        @withLogContext(ExposedLoggers.SDK)
        async cancelAllRuns(request:  jobs.CancelAllRuns,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _cancelRun(request:  jobs.CancelRun,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * running when this request completes.
        */
        @withLogContext(ExposedLoggers.SDK)
        async cancelRun(cancelRun: jobs.CancelRun,
            @context context?: Context    
        ): Promise<Waiter<
        EmptyResponse
    , jobs.Run>> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _create(request:  jobs.CreateJob,
            @context context?: Context
        ): Promise<
    ...
    * Create a new job.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(request:  jobs.CreateJob,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _delete(request:  jobs.DeleteJob,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * Deletes a job.
        */
        @withLogContext(ExposedLoggers.SDK)
        async delete(request:  jobs.DeleteJob,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _deleteRun(request:  jobs.DeleteRun,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * Deletes a non-active run. Returns an error if the run is active.
        */
        @withLogContext(ExposedLoggers.SDK)
        async deleteRun(request:  jobs.DeleteRun,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _exportRun(request:  jobs.ExportRunRequest,
            @context context?: Context
        ): Promise<
    ...
    * Export and retrieve the job run task.
        */
        @withLogContext(ExposedLoggers.SDK)
        async exportRun(request:  jobs.ExportRunRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _get(request:  jobs.GetJobRequest,
            @context context?: Context
        ): Promise<
    ...
    * Retrieves the details for a single job.
        */
        @withLogContext(ExposedLoggers.SDK)
        async get(request:  jobs.GetJobRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _getRun(request:  jobs.GetRunRequest,
            @context context?: Context
        ): Promise<
    ...
    * Retrieve the metadata of a run.
        */
        @withLogContext(ExposedLoggers.SDK)
        async getRun(getRunRequest: jobs.GetRunRequest,
            @context context?: Context    
        ): Promise<Waiter<
    ...
    , jobs.Run>> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _getRunOutput(request:  jobs.GetRunOutputRequest,
            @context context?: Context
        ): Promise<
    ...
    * beyond 60 days, you must save old run results before they expire.
        */
        @withLogContext(ExposedLoggers.SDK)
        async getRunOutput(request:  jobs.GetRunOutputRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _list(request:  jobs.ListJobsRequest,
            @context context?: Context
        ): Promise<
    ...
    * Retrieves a list of jobs.
        */
        @withLogContext(ExposedLoggers.SDK)
        async *list(request: jobs.ListJobsRequest,
            @context context?: Context    
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _listRuns(request:  jobs.ListRunsRequest,
            @context context?: Context
        ): Promise<
    ...
    * List runs in descending order by start time.
        */
        @withLogContext(ExposedLoggers.SDK)
        async *listRuns(request: jobs.ListRunsRequest,
            @context context?: Context    
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _repairRun(request:  jobs.RepairRun,
            @context context?: Context
        ): Promise<
    ...
    * history for the original job run.
        */
        @withLogContext(ExposedLoggers.SDK)
        async repairRun(repairRun: jobs.RepairRun,
            @context context?: Context    
        ): Promise<Waiter<
    ...
    , jobs.Run>> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _reset(request:  jobs.ResetJob,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * update job settings partially.
        */
        @withLogContext(ExposedLoggers.SDK)
        async reset(request:  jobs.ResetJob,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _runNow(request:  jobs.RunNow,
            @context context?: Context
        ): Promise<
    ...
    * Run a job and return the `run_id` of the triggered run.
        */
        @withLogContext(ExposedLoggers.SDK)
        async runNow(runNow: jobs.RunNow,
            @context context?: Context    
        ): Promise<Waiter<
    ...
    , jobs.Run>> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _submit(request:  jobs.SubmitRun,
            @context context?: Context
        ): Promise<
    ...
    * state after the job is submitted.
        */
        @withLogContext(ExposedLoggers.SDK)
        async submit(submitRun: jobs.SubmitRun,
            @context context?: Context    
        ): Promise<Waiter<
    ...
    , jobs.Run>> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _update(request:  jobs.UpdateJob,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * ResetJob to overwrite all job settings.
        */
        @withLogContext(ExposedLoggers.SDK)
        async update(request:  jobs.UpdateJob,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
