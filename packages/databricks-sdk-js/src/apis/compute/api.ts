...
export class ClusterPoliciesService {
    ...
    private async _create(
    ...
    ): Promise<compute.CreatePolicyResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as compute.CreatePolicyResponse;
    }
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<compute.ListPoliciesResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as compute.ListPoliciesResponse;
    }
...
export class ClustersService {
    ...
    @withLogContext(ExposedLoggers.SDK)
    private async _create(
        request: compute.CreateCluster,
        @context context?: Context
    ): Promise<compute.CreateClusterResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as compute.CreateClusterResponse;
    }
    ...
    async create(
        ...
        @context context?: Context
    ): Promise<Waiter<compute.CreateClusterResponse, compute.ClusterDetails>> {
    ...
    async delete(
        ...
        @context context?: Context
    ): Promise<Waiter<EmptyResponse, compute.ClusterDetails>> {
        const cancellationToken = context?.cancellationToken;
    ...
    private async _events(
        ...
        @context context?: Context
    ): Promise<compute.GetEventsResponse> {
    ...
    private async _get(
        ...
        @context context?: Context
    ): Promise<compute.ClusterDetails> {
    ...
    @withLogContext(ExposedLoggers.SDK)
    async get(
        getClusterRequest: compute.GetClusterRequest,
        @context context?: Context
    ): Promise<Waiter<compute.ClusterDetails, compute.ClusterDetails>> {
        const cancellationToken = context?.cancellationToken;
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<compute.ListClustersResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as compute.ListClustersResponse;
    }
    ...
    private async _listNodeTypes(
        @context context?: Context
    ): Promise<compute.ListNodeTypesResponse> {
        ...
        return (await this.client.request(
            ...
            undefined,
            context
        )) as compute.ListNodeTypesResponse;
    }
    ...
    private async _listZones(
        @context context?: Context
    ): Promise<compute.ListAvailableZonesResponse> {
        ...
        return (await this.client.request(
            ...
            undefined,
            context
        )) as compute.ListAvailableZonesResponse;
    }
    ...
    private async _restart(
        request: compute.RestartCluster,
        @context context?: Context
    ): Promise<EmptyResponse> {
    ...
    private async _sparkVersions(
        @context context?: Context
    ): Promise<compute.GetSparkVersionsResponse> {
        ...
        return (await this.client.request(
            ...
            undefined,
            context
        )) as compute.GetSparkVersionsResponse;
    }
...
export class CommandExecutionService {
    ...
    async cancel(
        ...
        @context context?: Context
    ): Promise<Waiter<EmptyResponse, compute.CommandStatusResponse>> {
        const cancellationToken = context?.cancellationToken;
    ...
    private async _commandStatus(
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as compute.CommandStatusResponse;
    }
    ...
    private async _contextStatus(
        ...
        @context context?: Context
    ): Promise<compute.ContextStatusResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as compute.ContextStatusResponse;
    }
    ...
    @withLogContext(ExposedLoggers.SDK)
    private async _create(
        request: compute.CreateContext,
        @context context?: Context
    ): Promise<compute.Created> {
    ...
    async create(
        ...
        @context context?: Context
    ): Promise<Waiter<compute.Created, compute.ContextStatusResponse>> {
        const cancellationToken = context?.cancellationToken;
    ...
    async execute(
        ...
        @context context?: Context
    ): Promise<Waiter<compute.Created, compute.CommandStatusResponse>> {
        const cancellationToken = context?.cancellationToken;
...
export class GlobalInitScriptsService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<compute.CreateResponse> {
    ...
    private async _get(
        ...
        @context context?: Context
    ): Promise<compute.GlobalInitScriptDetailsWithContent> {
        const path = `/api/2.0/global-init-scripts/${request.script_id}`;
        return (await this.client.request(
            path,
            "GET",
            request,
            context
        )) as compute.GlobalInitScriptDetailsWithContent;
    }
    ...
    private async _list(
        @context context?: Context
    ): Promise<compute.ListGlobalInitScriptsResponse> {
        const path = "/api/2.0/global-init-scripts";
        return (await this.client.request(
            path,
            "GET",
            undefined,
            context
        )) as compute.ListGlobalInitScriptsResponse;
    }
...
export class InstancePoolsService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<compute.CreateInstancePoolResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as compute.CreateInstancePoolResponse;
    }
    ...
    private async _get(
        ...
        @context context?: Context
    ): Promise<compute.GetInstancePool> {
    ...
    private async _list(
        @context context?: Context
    ): Promise<compute.ListInstancePools> {
...
export class InstanceProfilesService {
    ...
    private async _list(
        @context context?: Context
    ): Promise<compute.ListInstanceProfilesResponse> {
        ...
        return (await this.client.request(
            ...
            undefined,
            context
        )) as compute.ListInstanceProfilesResponse;
    }
...
export class LibrariesService {
    ...
    private async _allClusterStatuses(
        @context context?: Context
    ): Promise<compute.ListAllClusterLibraryStatusesResponse> {
        ...
        return (await this.client.request(
            ...
            undefined,
            context
        )) as compute.ListAllClusterLibraryStatusesResponse;
    }
    ...
    private async _clusterStatus(
        ...
        @context context?: Context
    ): Promise<compute.ClusterLibraryStatuses> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as compute.ClusterLibraryStatuses;
    }
...
export class PolicyFamiliesService {
    ...
    private async _list(
        ...
        @context context?: Context
    ): Promise<compute.ListPolicyFamiliesResponse> {
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as compute.ListPolicyFamiliesResponse;
    }
