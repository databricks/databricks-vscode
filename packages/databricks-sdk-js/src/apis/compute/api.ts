...
export class ClusterPoliciesService {
    constructor(readonly client: ApiClient){}
        ...
        private async _create(request:  compute.CreatePolicy,
    ...
    * Creates a new policy with prescribed settings.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(request:  compute.CreatePolicy,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _delete(request:  compute.DeletePolicy,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * run, but cannot be edited.
        */
        @withLogContext(ExposedLoggers.SDK)
        async delete(request:  compute.DeletePolicy,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _edit(request:  compute.EditPolicy,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * clusters governed by the previous policy invalid.
        */
        @withLogContext(ExposedLoggers.SDK)
        async edit(request:  compute.EditPolicy,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _get(request:  compute.GetClusterPolicyRequest,
            @context context?: Context
        ): Promise<
    ...
    * only.
        */
        @withLogContext(ExposedLoggers.SDK)
        async get(request:  compute.GetClusterPolicyRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _list(request:  compute.ListClusterPoliciesRequest,
            @context context?: Context
        ): Promise<
    ...
    * Returns a list of policies accessible by the requesting user.
        */
        @withLogContext(ExposedLoggers.SDK)
        async *list(request: compute.ListClusterPoliciesRequest,
            @context context?: Context    
        ): AsyncIterable<compute.Policy> {
...
export class ClustersService {
    constructor(readonly client: ApiClient){}
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _changeOwner(request:  compute.ChangeClusterOwner,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * operation.
        */
        @withLogContext(ExposedLoggers.SDK)
        async changeOwner(request:  compute.ChangeClusterOwner,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _create(request:  compute.CreateCluster,
            @context context?: Context
        ): Promise<
    ...
    * an informative error message.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(createCluster: compute.CreateCluster,
            @context context?: Context    
        ): Promise<Waiter<
    ...
    , compute.ClusterDetails>> {
            ...
            return asWaiter(createClusterResponse, async(options) => { 
                ...
                return await retry<compute.ClusterDetails>({
                    timeout,
                    fn: async () => {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _delete(request:  compute.DeleteCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * `TERMINATED` state, nothing will happen.
        */
        @withLogContext(ExposedLoggers.SDK)
        async delete(deleteCluster: compute.DeleteCluster,
            @context context?: Context    
        ): Promise<Waiter<
        EmptyResponse
    , compute.ClusterDetails>> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _edit(request:  compute.EditCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * Clusters created by the Databricks Jobs service cannot be edited.
        */
        @withLogContext(ExposedLoggers.SDK)
        async edit(editCluster: compute.EditCluster,
            @context context?: Context    
        ): Promise<Waiter<
        EmptyResponse
    , compute.ClusterDetails>> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _events(request:  compute.GetEvents,
            @context context?: Context
        ): Promise<
    ...
    * nparameters necessary to request the next page of events.
        */
        @withLogContext(ExposedLoggers.SDK)
        async *events(request: compute.GetEvents,
            @context context?: Context    
        ): AsyncIterable<compute.ClusterEvent> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _get(request:  compute.GetClusterRequest,
            @context context?: Context
        ): Promise<
    ...
    * terminated.
        */
        @withLogContext(ExposedLoggers.SDK)
        async get(getClusterRequest: compute.GetClusterRequest,
            @context context?: Context    
        ): Promise<Waiter<
    ...
    , compute.ClusterDetails>> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _list(request:  compute.ListClustersRequest,
            @context context?: Context
        ): Promise<
    ...
    * recently terminated job clusters.
        */
        @withLogContext(ExposedLoggers.SDK)
        async *list(request: compute.ListClustersRequest,
            @context context?: Context    
        ): AsyncIterable<compute.ClusterDetails> {
    ...
    * example, us-west-2a). These zones can be used to launch a cluster.
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _permanentDelete(request:  compute.PermanentDeleteCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * permanently deleted clusters.
        */
        @withLogContext(ExposedLoggers.SDK)
        async permanentDelete(request:  compute.PermanentDeleteCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _pin(request:  compute.PinCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * effect. This API can only be called by workspace admins.
        */
        @withLogContext(ExposedLoggers.SDK)
        async pin(request:  compute.PinCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _resize(request:  compute.ResizeCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * unless the cluster is in a `RUNNING` state.
        */
        @withLogContext(ExposedLoggers.SDK)
        async resize(resizeCluster: compute.ResizeCluster,
            @context context?: Context    
        ): Promise<Waiter<
        EmptyResponse
    , compute.ClusterDetails>> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _restart(request:  compute.RestartCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * currently in a `RUNNING` state, nothing will happen.
        */
        @withLogContext(ExposedLoggers.SDK)
        async restart(restartCluster: compute.RestartCluster,
            @context context?: Context    
        ): Promise<Waiter<
        EmptyResponse
    , compute.ClusterDetails>> {
    ...
    * to launch a cluster.
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _start(request:  compute.StartCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * nothing will happen. * Clusters launched to run a job cannot be started.
        */
        @withLogContext(ExposedLoggers.SDK)
        async start(startCluster: compute.StartCluster,
            @context context?: Context    
        ): Promise<Waiter<
        EmptyResponse
    , compute.ClusterDetails>> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _unpin(request:  compute.UnpinCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * effect. This API can only be called by workspace admins.
        */
        @withLogContext(ExposedLoggers.SDK)
        async unpin(request:  compute.UnpinCluster,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
...
export class CommandExecutionService {
    constructor(readonly client: ApiClient){}
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _cancel(request:  compute.CancelCommand,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * The command ID is obtained from a prior successful call to __execute__.
        */
        @withLogContext(ExposedLoggers.SDK)
        async cancel(cancelCommand: compute.CancelCommand,
            @context context?: Context    
        ): Promise<Waiter<
        EmptyResponse
    , compute.CommandStatusResponse>> {
            ...
            return asWaiter(null, async(options) => { 
                ...
                return await retry<compute.CommandStatusResponse>({
                    timeout,
                    fn: async () => {
                        const pollResponse = await this.commandStatus({
                            clusterId: cancelCommand.clusterId!,commandId: cancelCommand.commandId!,contextId: cancelCommand.contextId!,
                        }, context)
                        if(cancellationToken?.isCancellationRequested) {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _commandStatus(request:  compute.CommandStatusRequest,
            @context context?: Context
        ): Promise<
    ...
    * The command ID is obtained from a prior successful call to __execute__.
        */
        @withLogContext(ExposedLoggers.SDK)
        async commandStatus(request:  compute.CommandStatusRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _contextStatus(request:  compute.ContextStatusRequest,
            @context context?: Context
        ): Promise<
    ...
    * Gets the status for an execution context.
        */
        @withLogContext(ExposedLoggers.SDK)
        async contextStatus(request:  compute.ContextStatusRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _create(request:  compute.CreateContext,
            @context context?: Context
        ): Promise<
    ...
    * If successful, this method returns the ID of the new execution context.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(createContext: compute.CreateContext,
            @context context?: Context    
        ): Promise<Waiter<
    ...
    , compute.ContextStatusResponse>> {
            ...
            return asWaiter(created, async(options) => { 
                ...
                return await retry<compute.ContextStatusResponse>({
                    timeout,
                    fn: async () => {
                        const pollResponse = await this.contextStatus({
                            clusterId: createContext.clusterId!,contextId: created.id!,
                        }, context)
                        if(cancellationToken?.isCancellationRequested) {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _destroy(request:  compute.DestroyContext,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * Deletes an execution context.
        */
        @withLogContext(ExposedLoggers.SDK)
        async destroy(request:  compute.DestroyContext,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _execute(request:  compute.Command,
            @context context?: Context
        ): Promise<
    ...
    * execution.
        */
        @withLogContext(ExposedLoggers.SDK)
        async execute(command: compute.Command,
            @context context?: Context    
        ): Promise<Waiter<
    ...
    , compute.CommandStatusResponse>> {
            ...
            return asWaiter(created, async(options) => { 
                ...
                return await retry<compute.CommandStatusResponse>({
                    ...
                    fn: async () => {
                        const pollResponse = await this.commandStatus({
                            clusterId: command.clusterId!,commandId: created.id!,contextId: command.contextId!,
                        }, context)
                        if(cancellationToken?.isCancellationRequested) {
...
export class GlobalInitScriptsService {
    constructor(readonly client: ApiClient){}
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _create(request:  compute.GlobalInitScriptCreateRequest,
            @context context?: Context
        ): Promise<
    ...
    * Creates a new global init script in this workspace.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(request:  compute.GlobalInitScriptCreateRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _delete(request:  compute.DeleteGlobalInitScriptRequest,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * Deletes a global init script.
        */
        @withLogContext(ExposedLoggers.SDK)
        async delete(request:  compute.DeleteGlobalInitScriptRequest,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _get(request:  compute.GetGlobalInitScriptRequest,
            @context context?: Context
        ): Promise<
    ...
    * Gets all the details of a script, including its Base64-encoded contents.
        */
        @withLogContext(ExposedLoggers.SDK)
        async get(request:  compute.GetGlobalInitScriptRequest,
            @context context?: Context
        ): Promise<
    ...
    * script](#operation/get-script) operation.
        */
        ...
        async *list(
            @context context?: Context    
        ): AsyncIterable<compute.GlobalInitScriptDetails> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _update(request:  compute.GlobalInitScriptUpdateRequest,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * fields are optional. Unspecified fields retain their current value.
        */
        @withLogContext(ExposedLoggers.SDK)
        async update(request:  compute.GlobalInitScriptUpdateRequest,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
...
export class InstancePoolsService {
    constructor(readonly client: ApiClient){}
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _create(request:  compute.CreateInstancePool,
            @context context?: Context
        ): Promise<
    ...
    * Creates a new instance pool using idle and ready-to-use cloud instances.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(request:  compute.CreateInstancePool,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _delete(request:  compute.DeleteInstancePool,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * terminated asynchronously.
        */
        @withLogContext(ExposedLoggers.SDK)
        async delete(request:  compute.DeleteInstancePool,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _edit(request:  compute.EditInstancePool,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * Modifies the configuration of an existing instance pool.
        */
        @withLogContext(ExposedLoggers.SDK)
        async edit(request:  compute.EditInstancePool,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _get(request:  compute.GetInstancePoolRequest,
            @context context?: Context
        ): Promise<
    ...
    * Retrieve the information for an instance pool based on its identifier.
        */
        @withLogContext(ExposedLoggers.SDK)
        async get(request:  compute.GetInstancePoolRequest,
            @context context?: Context
        ): Promise<
    ...
    * Gets a list of instance pools with their statistics.
        */
        ...
        async *list(
            @context context?: Context    
        ): AsyncIterable<compute.InstancePoolAndStats> {
...
export class InstanceProfilesService {
    constructor(readonly client: ApiClient){}
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _add(request:  compute.AddInstanceProfile,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * This API is only available to admin users.
        */
        @withLogContext(ExposedLoggers.SDK)
        async add(request:  compute.AddInstanceProfile,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _edit(request:  compute.InstanceProfile,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * [Enable serverless SQL warehouses]: https://docs.databricks.com/sql/admin/serverless.html
        */
        @withLogContext(ExposedLoggers.SDK)
        async edit(request:  compute.InstanceProfile,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
    ...
    * This API is available to all users.
        */
        ...
        async *list(
            @context context?: Context    
        ): AsyncIterable<compute.InstanceProfile> {
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _remove(request:  compute.RemoveInstanceProfile,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * This API is only accessible to admin users.
        */
        @withLogContext(ExposedLoggers.SDK)
        async remove(request:  compute.RemoveInstanceProfile,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
...
export class LibrariesService {
    ...
    * the libraries UI.
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _clusterStatus(request:  compute.ClusterStatusRequest,
            @context context?: Context
        ): Promise<
    ...
    * guarantee.
        */
        @withLogContext(ExposedLoggers.SDK)
        async clusterStatus(request:  compute.ClusterStatusRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _install(request:  compute.InstallLibraries,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * be installed on all clusters via the libraries UI.
        */
        @withLogContext(ExposedLoggers.SDK)
        async install(request:  compute.InstallLibraries,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _uninstall(request:  compute.UninstallLibraries,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * are not installed on the cluster will have no impact but is not an error.
        */
        @withLogContext(ExposedLoggers.SDK)
        async uninstall(request:  compute.UninstallLibraries,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
...
export class PolicyFamiliesService {
    constructor(readonly client: ApiClient){}
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _get(request:  compute.GetPolicyFamilyRequest,
            @context context?: Context
        ): Promise<
    ...
    * Retrieve the information for an policy family based on its identifier.
        */
        @withLogContext(ExposedLoggers.SDK)
        async get(request:  compute.GetPolicyFamilyRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _list(request:  compute.ListPolicyFamiliesRequest,
            @context context?: Context
        ): Promise<
    ...
    * Retrieve a list of policy families. This API is paginated.
        */
        @withLogContext(ExposedLoggers.SDK)
        async *list(request: compute.ListPolicyFamiliesRequest,
            @context context?: Context    
        ): AsyncIterable<compute.PolicyFamily> {
            ...
            while(true) {
                ...
                if (!response.policy_families || response.policy_families.length === 0) {
                    break;
                }
