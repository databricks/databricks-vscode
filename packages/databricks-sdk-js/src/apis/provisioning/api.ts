...
export class CredentialsService {
    ...
    ): Promise<provisioning.Credential> {
    ...
    private async _list(
        @context context?: Context
    ): Promise<Array<provisioning.Credential>> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
...
export class EncryptionKeysService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<provisioning.CustomerManagedKey> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as provisioning.CustomerManagedKey;
    }
    ...
    private async _list(
        @context context?: Context
    ): Promise<Array<provisioning.CustomerManagedKey>> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
...
export class NetworksService {
    ...
    private async _list(
        @context context?: Context
    ): Promise<Array<provisioning.Network>> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
...
export class PrivateAccessService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<provisioning.PrivateAccessSettings> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as provisioning.PrivateAccessSettings;
    }
    ...
    private async _list(
        @context context?: Context
    ): Promise<Array<provisioning.PrivateAccessSettings>> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
...
export class StorageService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<provisioning.StorageConfiguration> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
        ...
        return (await this.client.request(
            ...
            request,
            context
        )) as provisioning.StorageConfiguration;
    }
    ...
    private async _list(
        @context context?: Context
    ): Promise<Array<provisioning.StorageConfiguration>> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
...
export class VpcEndpointsService {
    ...
    private async _create(
        ...
        @context context?: Context
    ): Promise<provisioning.VpcEndpoint> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
    ...
    private async _list(
        @context context?: Context
    ): Promise<Array<provisioning.VpcEndpoint>> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
...
export class WorkspacesService {
    ...
    @withLogContext(ExposedLoggers.SDK)
    private async _create(
        request: provisioning.CreateWorkspaceRequest,
        @context context?: Context
    ): Promise<provisioning.Workspace> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
    ...
    async create(
        ...
        @context context?: Context
    ): Promise<Waiter<provisioning.Workspace, provisioning.Workspace>> {
    ...
    private async _list(
        @context context?: Context
    ): Promise<Array<provisioning.Workspace>> {
        const config = this.client.config;
        await config.ensureResolved();
        if (!config.accountId || !config.isAccountClient()) {
            throw new Error("invalid Databricks Account configuration");
    ...
    private async _update(
        request: provisioning.UpdateWorkspaceRequest,
        @context context?: Context
    ): Promise<EmptyResponse> {
        const config = this.client.config;
        await config.ensureResolved();
    ...
    async update(
        ...
        @context context?: Context
    ): Promise<Waiter<EmptyResponse, provisioning.Workspace>> {
        const cancellationToken = context?.cancellationToken;
