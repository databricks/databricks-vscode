...
export const DefaultCreateRepo = {};

export interface DeleteRequest {
    // The ID for the corresponding repo to access.
    repo_id: string;
}
export const DefaultDeleteRequest = {};
...
export const DefaultListReposResponse = {};
...
export const DefaultUpdateRepo = {};
