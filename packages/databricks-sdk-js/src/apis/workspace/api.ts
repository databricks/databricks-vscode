...
export class GitCredentialsService {
    ...
    private async _delete(
        request: model.DeleteGitCredentialRequest,
        @context context?: Context
    ...
    @withLogContext(ExposedLoggers.SDK)
    private async _get(
        request: model.GetGitCredentialRequest,
        @context context?: Context
...
export class ReposService {
    ...
    @withLogContext(ExposedLoggers.SDK)
    private async _delete(
        request: model.DeleteRepoRequest,
        @context context?: Context
    ): Promise<model.EmptyResponse> {
    ...
    @withLogContext(ExposedLoggers.SDK)
    private async _list(
        request: model.ListReposRequest,
        @context context?: Context
...
export class WorkspaceService {
    ...
    @withLogContext(ExposedLoggers.SDK)
    private async _list(
        request: model.ListWorkspaceRequest,
        @context context?: Context
