...
export class CustomAppIntegrationService {
    constructor(readonly client: ApiClient){}
        ...
        private async _create(request:  oauth2.CreateCustomAppIntegration,
            @context context?: Context
        ): Promise<
        
            oauth2.CreateCustomAppIntegrationOutput
    ...
    * :method:CustomAppIntegration/get.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(request:  oauth2.CreateCustomAppIntegration,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _delete(request:  oauth2.DeleteCustomAppIntegrationRequest,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * custom oauth app integration via :method:CustomAppIntegration/get.
        */
        @withLogContext(ExposedLoggers.SDK)
        async delete(request:  oauth2.DeleteCustomAppIntegrationRequest,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _get(request:  oauth2.GetCustomAppIntegrationRequest,
            @context context?: Context
        ): Promise<
    ...
    * Gets the Custom OAuth App Integration for the given integration id.
        */
        @withLogContext(ExposedLoggers.SDK)
        async get(request:  oauth2.GetCustomAppIntegrationRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        private async _list(
            ...
            oauth2.GetCustomAppIntegrationsOutput
    ...
    * account
        */
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _update(request:  oauth2.UpdateCustomAppIntegration,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * custom oauth app integration via :method:CustomAppIntegration/get.
        */
        @withLogContext(ExposedLoggers.SDK)
        async update(request:  oauth2.UpdateCustomAppIntegration,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
...
export class OAuthEnrollmentService {
    constructor(readonly client: ApiClient){}
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _create(request:  oauth2.CreateOAuthEnrollment,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * status via API :method:OAuthEnrollment/get.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(request:  oauth2.CreateOAuthEnrollment,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
...
export class PublishedAppIntegrationService {
    constructor(readonly client: ApiClient){}
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _create(request:  oauth2.CreatePublishedAppIntegration,
            @context context?: Context
        ): Promise<
        
            oauth2.CreatePublishedAppIntegrationOutput
    ...
    * :method:PublishedAppIntegration/get.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(request:  oauth2.CreatePublishedAppIntegration,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _delete(request:  oauth2.DeletePublishedAppIntegrationRequest,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * published oauth app integration via :method:PublishedAppIntegration/get.
        */
        @withLogContext(ExposedLoggers.SDK)
        async delete(request:  oauth2.DeletePublishedAppIntegrationRequest,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _get(request:  oauth2.GetPublishedAppIntegrationRequest,
            @context context?: Context
        ): Promise<
        
            oauth2.GetPublishedAppIntegrationOutput
    ...
    * Gets the Published OAuth App Integration for the given integration id.
        */
        @withLogContext(ExposedLoggers.SDK)
        async get(request:  oauth2.GetPublishedAppIntegrationRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        private async _list(
            ...
            oauth2.GetPublishedAppIntegrationsOutput
    ...
    * Databricks account
        */
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _update(request:  oauth2.UpdatePublishedAppIntegration,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * published oauth app integration via :method:PublishedAppIntegration/get.
        */
        @withLogContext(ExposedLoggers.SDK)
        async update(request:  oauth2.UpdatePublishedAppIntegration,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
...
export class ServicePrincipalSecretsService {
    constructor(readonly client: ApiClient){}
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _create(request:  oauth2.CreateServicePrincipalSecretRequest,
            @context context?: Context
        ): Promise<
    ...
    * Create a secret for the given service principal.
        */
        @withLogContext(ExposedLoggers.SDK)
        async create(request:  oauth2.CreateServicePrincipalSecretRequest,
            @context context?: Context
        ): Promise<
    ...
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _delete(request:  oauth2.DeleteServicePrincipalSecretRequest,
            @context context?: Context
        ): Promise<
        EmptyResponse
    > 
    ...
    * Delete a secret from the given service principal.
        */
        @withLogContext(ExposedLoggers.SDK)
        async delete(request:  oauth2.DeleteServicePrincipalSecretRequest,
            @context context?: Context
        ): Promise<
        EmptyResponse
    >     
        ...
        @withLogContext(ExposedLoggers.SDK)
        private async _list(request:  oauth2.ListServicePrincipalSecretsRequest,
            @context context?: Context
        ): Promise<
    ...
    * not include the secret values.
        */
        @withLogContext(ExposedLoggers.SDK)
        async *list(request: oauth2.ListServicePrincipalSecretsRequest,
            @context context?: Context    
