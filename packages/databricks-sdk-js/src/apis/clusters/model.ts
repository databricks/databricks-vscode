...
export const DefaultChangeClusterOwner = {};
...
export const DefaultClientsTypes: Pick<ClientsTypes, "jobs" | "notebooks"> = {
    jobs: false,
    notebooks: false,
};
...
export const DefaultClusterAttributes: Pick<
    ClusterAttributes,
    "enable_elastic_disk" | "enable_local_disk_encryption"
> = {
...
export const DefaultClusterInfo: Pick<
    ClusterInfo,
    "enable_elastic_disk" | "enable_local_disk_encryption"
> = {
    enable_elastic_disk: false,
...
export const DefaultClusterSize = {};
...
export const DefaultCreateCluster: Pick<
    CreateCluster,
...
export const DefaultDeleteCluster = {};
...
export const DefaultEditCluster: Pick<
    EditCluster,
    | "apply_policy_default_values"
    | "enable_elastic_disk"
    | "enable_local_disk_encryption"
...
export const DefaultEventDetails: Pick<
    EventDetails,
...
export interface GetEvents {
    ...
    // are returned.
    event_types: GetEventsEventTypesItem[];
...
export const DefaultGetEventsResponse = {};

export interface GetSparkVersionsResponse {
    // All the available Spark versions.
    versions: SparkVersion[];
}
export const DefaultGetSparkVersionsResponse = {};
...
export const DefaultListAvailableZonesResponse = {};

export interface ListClustersResponse {
    // <needs content added>
    clusters: ClusterInfo[];
}
export const DefaultListClustersResponse = {};

export interface ListNodeTypesResponse {
    // The list of available Spark node types.
    node_types: NodeType[];
}
export const DefaultListNodeTypesResponse = {};
...
export const DefaultLogAnalyticsInfo = {};
...
export const DefaultLogSyncStatus = {};
...
export const DefaultNodeInstanceType = {};
...
export const DefaultNodeType: Pick<
    NodeType,
    | "is_deprecated"
...
> = {
    ...
    support_cluster_tags: false,
    support_ebs_volumes: false,
...
export const DefaultPermanentDeleteCluster = {};

export interface PinCluster {
    // <needs content added>
    cluster_id: string;
}
export const DefaultPinCluster = {};
...
export const DefaultResizeCluster = {};
...
export const DefaultRestartCluster = {};
...
export const DefaultS3StorageInfo: Pick<S3StorageInfo, "enable_encryption"> = {
...
export const DefaultSparkNode = {};

export interface SparkNodeAwsAttributes {
    // Whether this node is on an Amazon spot instance.
    is_spot: boolean;
}
export const DefaultSparkNodeAwsAttributes: Pick<
...
export const DefaultSparkVersion = {};

export interface StartCluster {
    // The cluster to be started.
    cluster_id: string;
}
export const DefaultStartCluster = {};
...
export const DefaultUnpinCluster = {};

export interface WorkloadType {
    // defined what type of clients can use the cluster. E.g. Notebooks, Jobs
    clients?: ClientsTypes;
}
export const DefaultWorkloadType = {};
