...
* account.
    */    
    ...
    constructor(config: ConfigOptions | Config, options: ClientOptions = {}) {
        ...
        this.accountAccessControl = new iam.AccountAccessControlService(this.apiClient);
        ...
        this.encryptionKeys = new provisioning.EncryptionKeysService(this.apiClient);
        this.accountGroups = new iam.AccountGroupsService(this.apiClient);
        this.accountIpAccessLists = new settings.AccountIpAccessListsService(this.apiClient);
        this.logDelivery = new billing.LogDeliveryService(this.apiClient);
        this.accountMetastoreAssignments = new catalog.AccountMetastoreAssignmentsService(this.apiClient);
        this.accountMetastores = new catalog.AccountMetastoresService(this.apiClient);
        this.networks = new provisioning.NetworksService(this.apiClient);
        this.oAuthEnrollment = new oauth2.OAuthEnrollmentService(this.apiClient);
        this.privateAccess = new provisioning.PrivateAccessService(this.apiClient);
        this.publishedAppIntegration = new oauth2.PublishedAppIntegrationService(this.apiClient);
        this.servicePrincipalSecrets = new oauth2.ServicePrincipalSecretsService(this.apiClient);
        this.accountServicePrincipals = new iam.AccountServicePrincipalsService(this.apiClient);
        this.accountSettings = new settings.AccountSettingsService(this.apiClient);
        this.storage = new provisioning.StorageService(this.apiClient);
        this.accountStorageCredentials = new catalog.AccountStorageCredentialsService(this.apiClient);
        this.accountUsers = new iam.AccountUsersService(this.apiClient);
        this.vpcEndpoints = new provisioning.VpcEndpointsService(this.apiClient);
        this.workspaceAssignment = new iam.WorkspaceAssignmentService(this.apiClient);
